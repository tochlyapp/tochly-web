    ...
    <div className="my-5 pt-sm-5">
      <Container>
        <Row className="justify-content-center">
          <Col md={8} lg={6} xl={5}>
            <Header title='Reset Password' description='Reset Password With Tochly.' />
            <Card>
            ...
            <div className="mt-5 text-center">
              <p>Remember It  ? <Link href="/auth/login" className="font-weight-medium text-primary">Signin</Link> </p>
