...
import SelectContact from 'src/pages/chat/components/SelectContact';
...
const UserChat = (props: any) => {
  ...
  const {
    ...
    {
      tid: tid as string,
      userId: activeChatRoom?.participant_id,
    },
    { skip: !activeChatRoom },
  );
    ...
    <React.Fragment>
      <div className="user-chat w-100 overflow-hidden">
        <div className="d-lg-flex">
          ...
          {(teamMembers && teamMembers.length > 0) && <Profile member={teamMembers[0]} canClose={true} />}
          {/* <UserProfileSidebar activeUser={active_user} /> */}
        </div>
      </div>
    </React.Fragment>
  );
