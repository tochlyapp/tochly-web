    ...
    <div className="my-5 pt-sm-5">
      <Container>
        <Row className="justify-content-center">
          <Col md={8} lg={6} xl={5}>
            <Header title='Register' description='Get your Tochly account now.' />
            <Card>
              <CardBody className="p-4">
                <Form noValidate onSubmit={handleSubmit(onSubmit)}>
                  <Row>
                    <Form.Group as={Col} md="6" controlId="firstName">
                      ...
                      <InputGroup className="input-group bg-soft-light rounded-3 mb-3" hasValidation>
                        ...
                        <Form.Control {...register("firstName")} type="text" placeholder="First Name" isInvalid={errors.firstName ? true : false} />
                        {errors.firstName && (
                    ...
                    <Form.Group as={Col} md="6" controlId="lastName">
                      ...
                      <InputGroup className="input-group bg-soft-light rounded-3 mb-3" hasValidation>
                        ...
                        <Form.Control {...register("lastName")} type="text" placeholder="Last Name" isInvalid={errors.lastName ? true : false} />
                        {errors.lastName && (
                          <Form.Control.Feedback type="invalid">
                  ...
                  <div className="mt-4 text-center">
                    <p className="text-muted mb-0">By registering you agree to the Tochly
            ...
            <div className="mt-5 text-center">
              <p>Already have an account ? <Link href="/auth/login" className="font-weight-medium text-primary">Signin</Link> </p>
