...
const LeftSidebarMenu = () => {
  ...
  const onChangeLayoutMode = (value: 'light' | 'dark') => {
  ...
  const changeLanguageAction = (lang: LanguagesCode) => {
    i18n.changeLanguage(lang);

    const languageMap: LanguagesMap = {
      sp: 'Spanish',
      gr: 'German',
      rs: 'Russian',
      it: 'Italian',
